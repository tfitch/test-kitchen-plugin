...
import hudson.Util;
import ci.kitchen.jenkins.Combination.BooleanCategory;
...
class FilterScript {
     ...
     */
    public boolean apply(KitchenBuildExecution context, Combination combination) {
    ...
    private Binding getConfiguredBinding(final KitchenBuildExecution execution) {
